...
public class SoundService extends BaseService implements ISoundService{
	private final static String TAG = SoundService.class.getCanonicalName();
	...
	public void startRingTone() {
		if(mRingtonePlayer == null){
			try{
				mRingtonePlayer = RingtoneManager.getRingtone(IMSDroid.getContext(), android.provider.Settings.System.DEFAULT_RINGTONE_URI);
			}catch(Exception e){
				e.printStackTrace();
				return;
			}
